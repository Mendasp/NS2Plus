...
Script.Load("lua/CHUD/Client/CHUD_Particles.lua")
Script.Load("lua/CHUD/Client/CHUD_MainMenu.lua")
Script.Load("lua/CHUD/Client/CHUD_Settings.lua")
Script.Load("lua/CHUD/Client/CHUD_Options.lua")
Script.Load("lua/CHUD/Client/CHUD_Atmospherics.lua")
Script.Load("lua/CHUD/Client/CHUD_Lights.lua")
Script.Load("lua/CHUD/Client/CHUD_UnitStatus.lua")
Script.Load("lua/CHUD/Client/CHUD_PlayerClient.lua")
Script.Load("lua/CHUD/Client/CHUD_Tracers.lua")
Script.Load("lua/CHUD/Client/CHUD_ScoreDisplay.lua")
Script.Load("lua/CHUD/Client/CHUD_Stats.lua")
...
AddClientUIScriptForClass("Marine", "CHUD/Client/CHUDGUI_DeathStats")
AddClientUIScriptForClass("Alien", "CHUD/Client/CHUDGUI_DeathStats")
AddClientUIScriptForClass("Spectator", "CHUD/Client/CHUDGUI_DeathStats")
