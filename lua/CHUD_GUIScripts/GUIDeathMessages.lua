...
Class_ReplaceMethod("GUIDeathMessages", "AddMessage",
	function(self, killerColor, killerName, targetColor, targetName, iconIndex, targetIsPlayer)
		...
		insertMessage["Weapon"]:SetPosition(Vector(killerTextWidth, -GUIScale(iconHeight) / 2, 0))
        ...
        local alpha = ConditionalValue(player and player:GetName() == killerName and targetIsPlayer, 1, 0)
        ...
        insertMessage["Background"].right:SetPosition(Vector(1, 0, 0))
