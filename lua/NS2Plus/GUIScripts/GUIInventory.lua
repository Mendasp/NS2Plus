local oldInventoryUpdate, LocalAjustSlot, CreateInventoryItem
LocalAdjustSlot = GetUpValue( GUIInventory.Update, "LocalAdjustSlot", { LocateRecurse = true })
CreateInventoryItem = GetUpValue( GUIInventory.Update, "CreateInventoryItem", { LocateRecurse = true })
oldInventoryUpdate = Class_ReplaceMethod("GUIInventory", "Update",
