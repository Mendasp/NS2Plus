...
CHUDOptions =
{
			...
			av = {
				...
				valueType = "int",
				applyFunction = function() CHUDRestartScripts({ "GUIAlienHUD" }) end,
				children = { "av_style", "av_offstyle", "av_close", "av_closeIntensity", "av_distant", "av_distantIntensity", "av_fog", "av_fogIntensity", "av_edges", "av_edgesize", "av_desat", "av_desatIntensity" },
