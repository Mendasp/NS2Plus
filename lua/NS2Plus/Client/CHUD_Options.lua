...
CHUDOptions =
{
			...
			nameplatesdistance = {
				...
				tooltip = "Chooses how far away, in meters, the nameplates render (ie. when aiming at a building to check its health). This includes teammate names. High values will decrease performance.",
				type = "slider",
				defaultValue = 13,
				minValue = 5,
				maxValue = 30,
