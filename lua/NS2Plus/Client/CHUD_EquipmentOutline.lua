...
local effectName = "shaders/EquipmentOutline.screenfx"
local cameras = {}

// Do this only for CompMod v3
if rawget(kTechId, "HeavyMachineGun") then
	_invRenderMask = bit.bnot(0x7c)
	lookup = { "GrenadeLauncher", "Shotgun", "Flamethrower", "HeavyMachineGun" }
	renderMasks = { [0] = 0x04, 0x08, 0x10, 0x20, 0x40 }
	effectName = "shaders/EquipmentOutlineCM.screenfx"
end
...
function EquipmentOutline_Initialize()
	...
	local screenEffect = Client.CreateScreenEffect(effectName)
